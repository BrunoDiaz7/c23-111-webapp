        ...
        <div className="h-full w-full bg-[#f5f5f5] p-10 rounded-2xl grid grid-cols-1 xl:grid-cols-[700px_1fr]  items-start relative">
          <div className="xl:sticky top-10 right-0">
            ...
            <p className="my-5 text-lg">
              Hola! Somos un equipo de desarrolladores creado por la plataforma
              de <span className="text-primary font-semibold">NoCountry</span>{" "}
              unidos por la pasión de crear soluciones tecnológicas innovadoras.
              Provenientes de distintos países, nos unimos para dar vida a un
              proyecto único:{" "}
              <span className="text-primary font-semibold">
                un recetario interactivo.
              </span>{" "}
              Este proyecto permite a los usuarios encontrar recetas deliciosas
              y adaptadas a sus necesidades mediante filtros fáciles de usar.
              Nuestro equipo está compuesto por tres desarrolladores{" "}
              <span className="text-primary font-semibold">Backend</span> y dos{" "}
              <span className="text-primary font-semibold">Frontend</span> ,
              trabajando de manera colaborativa para crear una plataforma
              intuitiva y dinámica. ¡Nos encanta compartir nuestra pasión por la
              programación y la cocina!
            </p>
          </div>
          <section>
            <div className="flex justify-center items-center flex-wrap">
              {compañeros
                .filter((companiero) => companiero.rol == "Backend")
                .map((compañero) => {
                  return (
                    <div
                    ...
                    >
                      ...
                      <div className="flex justify-between gap-3">
                        <a
                          ...
                          target="_blank"
                        >
                          <GitHubIcon href={compañero.github} />
                        </a>
                        ...
                        <a
                          ...
                          target="_blank"
                        >
                          <LinkedInIcon href={compañero.linkedin} />
                        </a>
                      </div>
                    </div>
                  );
            ...
            <div className="flex justify-center items-center flex-wrap">
              {compañeros
                .filter((companiero) => companiero.rol == "Frontend")
                .map((compañero) => {
                  return (
                    <div
                      key={compañero.nombre}
